package cuie.module05.led_animated_solution.demo;
...
import cuie.module05.led_animated_solution.LED;
...
public class DemoPane extends BorderPane {
    ...
    private void setupBindings() {
        ...
        led.blinkingProperty().bindBidirectional(pm.gateKeepingProperty());
        led.blinkRateProperty().bindBidirectional(pm.pulseProperty());
    }
