...
public class LED extends Region {
    ...
    //all properties
    //Zustandsinformation kommt in selbstverwaltete Properties
    ...
    public LED() {
        ...
        setupEventHandler(); //Alle Userinputs werden generiert
        setUpValueChangeListener(); //Reaktion auf Userinputs
    ...
    private void initializeParts() {
        ...
        highlight.setMouseTransparent(true); //Soll transparent sein bzgl Mausklicks
    ...
    //Alle Userinputs werden generiert //Alle Eventhandler
    private void setupEventHandler(){
        frame.setOnMouseClicked(event -> setOn(!isOn()));  //Alle Eventhandler fangen mit setOn an  ...(was passieren soll)
    }

    private void setUpValueChangeListener(){
        on.addListener((observable, oldValue, newValue) -> {  //Property.addListener(Wie muss UI reagieren, wenn sich interner Zustand geändert hat)
